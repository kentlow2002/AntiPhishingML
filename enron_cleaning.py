...
# Configuration
input_file = 'Cleaning/enron_data_fraud_labeled.csv'
columns_to_remove = [
...
if columns_to_remove:
    ...
    print(f"Unwanted columns removed and initial data saved to '{input_file}'")
else:
...
print(f"Final filtered data saved to '{input_file}'")
